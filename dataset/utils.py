...
def calculate_num_segments(
    ...
    overlap_samples = segment_length * overlap # -> 6
    step_samples = segment_length - overlap_samples # -> 24

    num_segments = int((audio_duration - segment_length) // step_samples + 1) #-> (30-30)//24+1
